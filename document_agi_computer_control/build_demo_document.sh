...
python3 stdout_redirect_progress.py -- python3 -u recursive_document_writer.py -d "/media/root/Toshiba XG3/works/prometheous/document_agi_computer_control/demo_document_repository" -u "https://github.com/james4ever0/agi_computer_control"
