...
cached_paths = ["/media/root/Toshiba XG3/works/prometheous/document_agi_computer_control/recursive_document_writer.py", "/media/root/Toshiba XG3/works/prometheous/document_agi_computer_control/code_view_with_path_argument_and_anchor/code_view_demo.py"]
...
def add_tree_contents(parent, contents, basedir=".", basemap={}):
    for item in contents:
        if item["type"] == "directory":
            ...
            #     guide_style=GREY,
            # )
            subtree = patch_missing_files(os.path.join(basedir, item["name"] + "/"), basemap,GREY, lambda x: Text.assemble((x, "bold")))
